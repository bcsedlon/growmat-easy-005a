...
#define MENU_ITEM           const PROGMEM OMMenuItem   //added the const for progmem
#define MENU_LIST           const PROGMEM OMMenuItem*	
...
#define MENU_SELECT_LIST    const PROGMEM OMMenuSelectListItem*
...
//add line to make it work with new gcc
...
//add line to make it work with newer gcc
//  void* list;
    const void* list;
};
...
struct OMMenuItem {
    ...
    uint8_t       type;
    uint8_t       targetCount;
//add line to make work with newer gcc
//  void*         target;
    const void*   target;
};
...
private:
    ...
    void        _modifyTemp(uint8_t p_type, uint8_t p_mode, long p_min, long p_max, char ch);
